...
.Processing Activity: HR Personio Process 02 - Onboarding Employee
|===
| | 
...
|Data Types
|surname, prefixes, given name(s), initials, date of birth, nationality, gender, marital status, BSN/social security number, residential address, personal phone number, email address, bank account number, start employee contract, salary, tax discount, emergency contact; see the respective sheet: https://docs.google.com/spreadsheets/d/11I2UKIeacDxEwV_kBcyZ7C6mKkvpwPPe
|===
